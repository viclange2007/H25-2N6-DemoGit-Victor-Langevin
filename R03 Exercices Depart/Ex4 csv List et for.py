...
os.chdir("csvs")
with open("Ex4 Emplois Reseautique.csv", "r", encoding="utf-8") as fichier_lu :
    csv_reader = csv.reader(fichier_lu, delimiter=';')
    for ligne in csv_reader :
       if(ligne[-2] == "Non déterminé" or ligne[-2] == "Dec") :
        print(ligne)
...
with open(ficher_a_lire, "r", encoding="utf-8") as fichier_a_lire :
    csv_reader = csv.reader(fichier_a_lire, delimiter=';')
    for ligne in csv_reader :
       if(ligne[-2] == "Non déterminé" or ligne[-2] == "Dec") :
        print(ligne)
